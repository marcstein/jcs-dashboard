...
TEMPLATES = [
    ...
    },
    {
        ...
        "category": "pleading",
        "subcategory": "pfr",
        "tags": ["pfr", "petition", "review", "dor", "refusal", "revocation"],
        "deactivate_patterns": ["PFR - %", "PFR  - %", "Petition for Review - %"],
        "case_variables": ["court_jurisdiction", "petitioner_name", "case_number", "dln", "dob", "arrest_date", "arrest_county", "police_department"],
